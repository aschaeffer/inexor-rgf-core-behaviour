...
//         impl crate::behaviour::relation::RelationBehaviourFactory<$reactive_type>
//             for $factory_name
//         {
//             fn build(
//                 &self,
...
//                 let behaviour_instance =
//                     <$behaviour_type>::from_relation_instance(relation_instance);
...
//         #[waiter_di::provides]
//         fn $create_factory_name() -> crate::factory::relation::$factory_name {
//             $factory_name {}
//         }
//     };
// }
